...
const Pagination = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-1/2  bg-gray-500 leading-normal"
    ...
    className: "border-b-2 border-gray-200 bg-gray-100 px-2 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-700"
  }, "Email"))), /*#__PURE__*/React.createElement("tbody", null, records.map((d, i) => /*#__PURE__*/React.createElement("tr", {
    key: i
  }, /*#__PURE__*/React.createElement("td", {
    className: "border-b border-gray-200 bg-white px-3 py-3 text-sm"
  }, d.ID), /*#__PURE__*/React.createElement("td", {
    className: "border-b border-gray-200 bg-white px-3 py-3 text-sm"
  }, d.name), /*#__PURE__*/React.createElement("td", {
    className: "border-b border-gray-200 bg-white px-3 py-3 text-sm"
  }, d.email))))), /*#__PURE__*/React.createElement("nav", {
